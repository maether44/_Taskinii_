    ...
    <Pressable onPress={handlePress} hitSlop={6} style={cup.wrap}>
      <Animated.View style={[cup.outer, scaleStyle]}>
        ...
        <Animated.View
          style={[
            cup.glowRing,
            { backgroundColor: C.blueGlow + '22', borderColor: C.blueGlow + '60' },
            glowStyle,
          ]}
        />
        ...
        {/* ml label below cup */}
        <Text style={[cup.label, filled && { color: C.blue, fontWeight: '800' }]}>{CUP_ML}</Text>
      </Animated.View>
    </Pressable>
  );
}
  ...
  return (
    <View style={t.card}>
      ...
      <View style={t.progressBg}>
        <Animated.View
          style={[t.progressFill, barStyle, goalReached && { backgroundColor: C.success }]}
        />
      </View>
      ...
      <Text style={t.glassesLabel}>
        {filledCount} / {totalCups} glasses ·{' '}
        {totalCups * CUP_ML - waterMl > 0
      ...
      <View style={t.quickRow}>
        ...
        <Pressable
          ...
          style={({ pressed }) => [
            t.undoBtn,
            pressed && t.quickBtnActive,
            waterMl <= 0 && t.disabledBtn,
          ]}
        >
