...
export default function ThemeToggle({ style }) {
  ...
  useEffect(() => {
    Animated.parallel([
      Animated.spring(slide,  { toValue: isDark ? 0 : 1, useNativeDriver: true, speed: 20, bounciness: 8 }),
  ...
  return (
    ...
    >
      ...
      <Animated.View
        style={[
          styles.knob,
          { backgroundColor: knobBg, transform: [{ translateX: knobTranslate }, { rotate: iconSpin }] },
        ]}
      >
        <Ionicons
