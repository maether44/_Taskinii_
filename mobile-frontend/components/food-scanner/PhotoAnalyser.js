    ...
    return (
        <View style={s.root}>
            ...
            <View style={s.controls}>
                ...
                {/* Capture button */}
                <TouchableOpacity style={s.captureRing} onPress={takePhoto} disabled={loading} activeOpacity={0.85}>
...
const s = StyleSheet.create({
    ...
    frameOverlay: {
        ...
        width: FRAME, height: FRAME, alignItems: 'center', justifyContent: 'center',
    },
    corner: { position: 'absolute', width: CORNER_SIZE, height: CORNER_SIZE },
    tl: { top: 0, left: 0, borderTopWidth: BORDER, borderLeftWidth: BORDER, borderColor: LIME, borderTopLeftRadius: 6 },
    tr: { top: 0, right: 0, borderTopWidth: BORDER, borderRightWidth: BORDER, borderColor: LIME, borderTopRightRadius: 6 },
    bl: { bottom: 0, left: 0, borderBottomWidth: BORDER, borderLeftWidth: BORDER, borderColor: LIME, borderBottomLeftRadius: 6 },
    br: { bottom: 0, right: 0, borderBottomWidth: BORDER, borderRightWidth: BORDER, borderColor: LIME, borderBottomRightRadius: 6 },
    frameLabel: {
        color: '#ffffff88', fontSize: 12, fontWeight: '600',
    ...
    captureRing: {
        ...
        borderWidth: 2, borderColor: PURPLE + '55',
    ...
    aiBadge: {
        width: 48, height: 48, borderRadius: 24,
        backgroundColor: LIME + '25', alignItems: 'center', justifyContent: 'center',
    ...
    loadingCard: {
        backgroundColor: 'rgba(14,14,14,0.95)', borderRadius: 20,
        padding: 28, alignItems: 'center', gap: 14,
        borderWidth: 1, borderColor: LIME + '22', minWidth: 200,
    },
