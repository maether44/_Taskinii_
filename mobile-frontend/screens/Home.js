...
export default function Home({ navigation }) {
  ...
  // Hydration notification: only run when stats are loaded
  useNotification(stats?.water?.current ?? 0, stats?.water?.target ?? 2000);
  ...
  return (
    <View style={styles.root}>
      ...
      >
        ...
        {/* 2. MOTIVATIONAL QUOTE OF THE DAY (Glow Card) */}
        <BentoCard delay={100}>
          <LinearGradient
        ...
        <View style={styles.bentoGrid}>
          ...
          <View style={styles.macroColumn}>
            <BentoCard style={styles.macroSmallCard} delay={300}>
              <Text style={[styles.macroLabel, { color: COLORS.lime }]}>
                PROTEIN
              </Text>
            ...
            <BentoCard style={styles.macroSmallCard} delay={400}>
              <Text style={[styles.macroLabel, { color: "#378ADD" }]}>
                CARBS
              </Text>
                  ...
                  <View
                    style={[
                      styles.barFill,
                      {
                        width: `${m.fatigue_pct}%`,
                        backgroundColor:
                          m.fatigue_pct >= 70 ? "#FF9500" : "#C8F135",
                      },
                    ]}
                  />
                </View>
