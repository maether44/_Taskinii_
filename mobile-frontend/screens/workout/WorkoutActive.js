        ...
        <>
          ...
          {circuit && (
            <BlurView intensity={30} tint="dark" style={s.circuitPill}>
              ...
              <Text style={s.circuitPillTxt}>
                {circuitPos}/{circuitTotal}
              </Text>
              {hasNext && (
                <Text style={s.circuitPillNext}>Next: {circuit[circuitIndex + 1]?.name}</Text>
              )}
            </BlurView>
          )}
        ...
        <View style={s.restOverlay}>
          ...
          {hasNext && (
            <>
              ...
              <Text style={s.restExTarget}>
                {circuit[circuitIndex + 1]?.target} · {circuit[circuitIndex + 1]?.sets}
              </Text>
            </>
          )}
