		...
		<View style={s.root}>
			<ScrollView contentContainerStyle={s.scroll} showsVerticalScrollIndicator={false}>
				...
				<View style={s.banner}>
					...
					<View style={s.bannerTextWrap}>
						...
						<Text style={s.bannerBody}>
							These notes explain how BodyQ treats personal data, app preferences, and estimation inputs.
						</Text>
					</View>
				</View>
				...
				<View style={s.sectionCard}>
					...
					<Text style={s.sectionSubtitle}>Core points for privacy and usage.
					</Text>
				...
				<View style={s.sectionCard}>
					...
					<View style={s.actionRow}>
						<Pressable style={[s.actionBtn, s.actionBtnGhost]} onPress={() => navigation.navigate('TrustCenter')}>
							<Text style={s.actionBtnGhostText}>Open Trust Center</Text>
						</Pressable>
						<Pressable style={[s.actionBtn, s.actionBtnPrimary]} onPress={() => navigation.navigate('HelpCenter')}>
