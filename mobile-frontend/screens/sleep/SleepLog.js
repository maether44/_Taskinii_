          ...
          {HOUR_OPTIONS.map((h) => (
            <TouchableOpacity
              ...
              style={[
                s.hourChip,
                hours === h && {
                  borderColor: sleepColor(h),
                  backgroundColor: sleepColor(h) + '15',
                },
              ]}
              onPress={() => setHours(h)}
            >
              <Text
                style={[
                  s.hourChipTxt,
                  hours === h && { color: sleepColor(h), fontWeight: FontWeight.bold },
                ]}
              >
                {h}h
              </Text>
        ...
        <View style={s.goalBar}>
          <View style={s.goalBarBg}>
            <View
              style={[
                s.goalBarFill,
                { width: `${Math.min(hours / 10, 1) * 100}%`, backgroundColor: color },
              ]}
            />
        ...
        <View style={s.qualityRow}>
          {QUALITY_OPTIONS.map((q) => (
            <TouchableOpacity
              ...
              style={[
                s.qualityBtn,
                quality === q.value && { borderColor: q.color, backgroundColor: q.color + '12' },
              ]}
            ...
            >
              ...
              <Text
                style={[
                  s.qualityLabel,
                  quality === q.value && { color: q.color, fontWeight: FontWeight.bold },
                ]}
              >
                {q.label}
              </Text>
                  ...
                  {options.map((t) => (
                    ...
                    >
                      <Text
                        style={[
                          s.timeChipTxt,
                          value === t && { color: Colors.sleep, fontWeight: FontWeight.bold },
                        ]}
                      >
                        {t}
                      </Text>
